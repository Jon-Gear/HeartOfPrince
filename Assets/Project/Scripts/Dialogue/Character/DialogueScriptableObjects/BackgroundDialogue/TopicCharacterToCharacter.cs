...
[Serializable]
[CreateAssetMenu(menuName = "Dialogue/Topic Character to Character", order = 7)]
public class TopicCharacterToCharacter : Topic
{
    ...
    public override string GetTopicNodeName()
    {
        ...
        nodeName += "{actor}_topic_character_to_character_";
