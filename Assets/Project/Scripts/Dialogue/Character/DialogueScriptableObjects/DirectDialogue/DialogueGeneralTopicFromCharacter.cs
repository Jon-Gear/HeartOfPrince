...
[Serializable]
[CreateAssetMenu(menuName = "Dialogue/General Dialogue Topic From Character to Player", order = 6)]
/// <summary>
/// A general topic which can have multiple dialogue variants, chosen randomly when requested.
/// </summary>
public class DialogueGeneralTopicFromCharacter : DialogueTopicFromCharacter
{
